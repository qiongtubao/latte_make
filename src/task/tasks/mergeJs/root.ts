(function () {
  if ((<any>window).latte && (<any>window).latte.define) {
    return;
  }
  ...
  if (!LATTE_NAMESPACE && typeof (<any>window).requirejs !== "undefined")
    return;

  var _define: any = function (module, deps, payload) {
  ...
  var _require: any = function (parentId, module, callback) {
  ...
  var normalizeModule = function (parentId, moduleName) {
    ...
    let name = resolve(parentId, moduleName);
...
(<any>window).latte.global = this;
this.define = (<any>window).latte.define;
(function () {
  this.config = {};
}).call((<any>window).latte);
